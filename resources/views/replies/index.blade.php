          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Topic_id</th> <th>User_id</th> <th>Content</th> <th>Created_at</th> <th>Update_time</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$reply->topic_id}}</td> <td>{{$reply->user_id}}</td> <td>{{$reply->content}}</td> <td>{{$reply->created_at}}</td> <td>{{$reply->update_time}}</td>
