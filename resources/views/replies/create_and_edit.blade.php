        ...
        @endif
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="created_at" id="created_at-field" value="{{ old('created_at', $reply->created_at ) }}" />
                </div> 
                <div class="form-group">
                    <label for="update_time-field">Update_time</label>
                    <input class="form-control" type="text" name="update_time" id="update_time-field" value="{{ old('update_time', $reply->update_time ) }}" />
                </div>
